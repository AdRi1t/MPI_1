...
+ SCRIPT_PID=156317
+ /bin/bash -x /ccc/scratch/cont001/ocre/tabernera/.SPOOL/batch/scripts/script.2120438
+ set +x
+ unset _mlshdbg
+ '[' 1 = 1 ']'
+ case "$-" in
...
# time limit               : 180 s
# time used                : 17 s
# cpus usage (avg)         : 50.00% 
################################################################

SLURM General Summary
--------------------
JobId=2120438 JobName=MPI_PMV
   ...
   DerivedExitCode=0:0
   RunTime=00:00:19 TimeLimit=00:03:00 TimeMin=N/A
   SubmitTime=2023-05-17T11:19:37 EligibleTime=2023-05-17T11:19:37
   AccrueTime=2023-05-17T11:19:37
   StartTime=2023-05-17T11:19:38 EndTime=2023-05-17T11:22:38 Deadline=N/A
   SuspendTime=None SecsPreSuspend=0 LastSchedEval=2023-05-17T11:19:38 Scheduler=Main
   Partition=rome AllocNode:Sid=inti6015:153391
   ...
   Command=/tmp/MPI_job32.sh_aV9AX9
...
2120438.bat+            batch                                                   
2120438.ext+           extern                                                   
2120438.0             pmv_mpi     33284K          0         inti6015   17892096 

SLURM Accounting Summary
------------------------
         JobName          Account      NCPUS   NNodes   NTasks    Elapsed ExitCode      State 
---------------- ---------------- ---------- -------- -------- ---------- -------- ---------- 
         MPI_PMV         ocre@cpu         32        1            00:00:19      0:0    ENDING
           batch         ocre@cpu         32        1        1   00:00:19      0:0    ENDING
          extern         ocre@cpu         32        1        1   00:00:19      0:0    ENDING
         pmv_mpi         ocre@cpu         32        1       32   00:00:09      0:0  COMPLETED 
...
---------------- ---------- ----------  --------------
           batch          0          0        0.00 kWh
          extern          0          0        0.00 kWh
         pmv_mpi    Unknown  15033.61M        0.00 kWh
                                        --------------
                                Total:        0.00 kWh

Wed May 17 11:19:57 CEST 2023 : suppression MSUB_TMPDIR
